...
class CategoryColorsView: UIView {
    ...
    private func fillColorView() {
        ...
        for color in colors {
            ...
            let colorView = ColorView(color: color, frame: CGRect(x: x, y: 0, width: size, height: size))
...
extension CategoryColorsView : ColorViewDelegate {
