//
// LegacyWalletReceiveViewController.swift
// BeamWallet
//
...
class LegacyWalletReceiveViewController: BaseViewController {
    ...
    @IBAction func onQRCode(sender :UIButton) {
        let modalViewController = ReceiveQRViewController(address: address, amount: amountField.text)
...
extension LegacyWalletReceiveViewController : ReceiveQRViewControllerDelegate {
    func onCopyDone() {
        self.navigationController?.popViewController(animated: true)
    }
}
...
extension LegacyWalletReceiveViewController : UITextFieldDelegate {
...
extension LegacyWalletReceiveViewController {
