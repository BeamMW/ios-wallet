...
protocol ReceiveQRViewControllerDelegate: AnyObject {
    func onCopyDone()
}

class ReceiveQRViewController: BaseViewController {

    weak var delegate: ReceiveQRViewControllerDelegate?
