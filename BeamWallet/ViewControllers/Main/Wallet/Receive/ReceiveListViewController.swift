...
class ReceiveListViewController: BaseTableViewController {
    ...
    override func viewDidLoad() {
        ...
        tableView.register([BMAddressCell.self, BMFieldCell.self, BMEmptyCell.self])
...
extension ReceiveListViewController : UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if addresses.count == 0 {
            ...
            cell.configure(with: (row: indexPath.row, address: addresses[indexPath.row], displayTransaction: true))
