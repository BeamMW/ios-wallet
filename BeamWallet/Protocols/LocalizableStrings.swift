...
class LocalizableStrings : NSObject {
    ...
    var local_annotation_not_shared = "local_annotation_not_shared".localized.uppercased().replacingOccurrences(of: "wont_shared".localized.uppercased(), with: "wont_shared".localized.lowercased())
    ...
    var paste_enter_address = "paste_enter_address".localized.uppercased()
    ...
    var send_address_secure = "send_address_secure".localized
    ...
    var transaction_comment = "transaction_comment".localized.uppercased().replacingOccurrences(of: "not_shared".localized.uppercased(), with: "not_shared".localized.lowercased())
