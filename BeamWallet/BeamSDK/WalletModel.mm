...
void WalletModel::onStatus(const WalletStatus& status)
{
    ...
    walletStatus.linked = status.linked;
    walletStatus.unlinked = status.unlinked;
    ...
    walletStatus.realUnlinked = double(int64_t(status.unlinked)) / Rules::Coin;
    walletStatus.realLinked = double(int64_t(status.linked)) / Rules::Coin;
